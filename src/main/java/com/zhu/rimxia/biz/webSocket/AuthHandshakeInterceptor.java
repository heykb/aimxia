...
public class AuthHandshakeInterceptor implements HandshakeInterceptor {
    ...
    /*    HttpSession session = SpringContextUtils.getSession();
        ...
        System.out.println(request.getServletRequest().getParameter("token"));
        System.out.println(request.getServletRequest().getAttribute("nini"));
        System.out.println("ninnininininin");
        return true;
    }
